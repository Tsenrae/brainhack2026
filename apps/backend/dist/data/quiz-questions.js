...
export const SPOT_THE_SPIN_QUESTIONS = [
    // ── Q0 ── post / scam ────────────────────────────────────────────────────────
    {
        id: 1,
        question_type: 'post',
        ...
        comments: '3.4K',
        correct_answer: 'scam',
        hint: 'Look for urgency tactics, unrealistic promises, and lack of official sources. Government announcements are always made through official channels like gov.sg.',
        explanation: 'This post is a financial scam. Real government disbursements are announced through gov.sg, official press releases, and CNA — never via viral social media links with countdown timers. The goal is to steal your personal information or money.',
        red_flags: [
    ...
    // ── Q2 ── post / misleading ──────────────────────────────────────────────────
    {
        id: 3,
        question_type: 'post',
        content: 'New survey reveals 99% of Singaporeans want the government to increase cash rebates by 500%. Citizens are "deeply unhappy" with current policies, says unnamed political analyst.',
        likes: '5.3K',
        shares: '3.1K',
        comments: '2.2K',
        correct_answer: 'misleading',
        hint: 'Who conducted this survey? How many people were surveyed? Who is the "unnamed analyst"? Real surveys always cite methodology, sample size, and the institution that ran them.',
        explanation: 'This is misleading content. The 99% figure has no sourcing — no survey name, methodology, or sample size. "Unnamed political analyst" is not a credible citation. Statistics this extreme without a verifiable source are a red flag for fabricated or heavily manipulated data.',
        red_flags: [
    ...
    // ── Q3 ── post / satire ──────────────────────────────────────────────────────
    {
        id: 4,
        question_type: 'post',
        content: '📰 The Onion SG: "Government to mandate that all HDB flats install mandatory AI mood sensors to detect unhappy residents and deploy happiness drones." — New Smart Nation initiative announced.',
        likes: '18.9K',
        shares: '11.2K',
        comments: '4.6K',
        correct_answer: 'satire',
        hint: 'Look at the source name and the absurdity of the premise. Is this content from a known parody publication?',
        explanation: 'This is satire. The Onion SG is a satirical publication known for exaggerated, fictional news about Singapore. Happiness drones and AI mood sensors are intentionally absurd. Satire uses humour and exaggeration to comment on society — it is not meant to be taken literally, even when it mimics a real news format.',
        red_flags: [],
        manipulation_tactics: [],
    },
    // ── Q4 ── post / real ────────────────────────────────────────────────────────
    {
        id: 5,
        question_type: 'post',
        content: '🦟 NEA Alert: A new dengue cluster has been identified in Tampines Street 45. Residents are advised to remove stagnant water from flower pots, pails, and roof gutters. Check NEA\'s myENV app for updates.',
        likes: '3.2K',
        shares: '9.8K',
        comments: '1.1K',
        correct_answer: 'real',
        hint: 'Does this look like an official advisory with a specific location, practical actionable steps, and a reference to a verifiable government source you can independently check?',
        explanation: 'This is real, accurate public health information. NEA regularly publishes dengue cluster alerts with precise locations and practical prevention steps. The reference to the official myENV app for verification is consistent with genuine NEA communications. Notice the absence of urgency, fear-mongering, or suspicious links.',
        red_flags: [],
        manipulation_tactics: [],
    },
    // ── Q5 ── VIDEO / misleading ─────────────────────────────────────────────────
    {
        ...
        video_description: 'A smartly-dressed person sits at a professional-looking desk with a Singapore flag visible in the background. Speaking in an authoritative tone, they introduce themselves as representing the Ministry of Finance and announce a "$1,500 Singapore Recovery Assistance Package" available to all eligible Singaporeans. The video shows an official-looking graphic and asks viewers to visit a link to claim their payment — but warns that slots are limited and the offer closes in 48 hours.',
        correct_answer: 'misleading',
        hint: 'Real government grants are announced on official government websites like mof.gov.sg and budget.gov.sg — never via viral videos with countdown timers. Check: does the URL shown end in .gov.sg?',
        explanation: 'This is misleading content — specifically a government impersonation video. The URL shown (sg-recovery-gov.xyz) is not a government domain. Real Ministry of Finance announcements appear on mof.gov.sg and are reported by CNA, The Straits Times, and other mainstream media. The artificial 48-hour deadline and "limited slots" language are classic manipulation tactics not used in legitimate government communications.',
        red_flags: [
    ...
    // ── Q6 ── post / scam ────────────────────────────────────────────────────────
    {
        id: 7,
        question_type: 'post',
        content: '🌟 HIRING NOW! Work from home, earn $300–$500/DAY! No experience needed! Just like & share social media posts for brands. WhatsApp us NOW: +65 8888 7777. Limited slots available! 🌟',
        likes: '4.2K',
        shares: '6.8K',
        comments: '1.9K',
        correct_answer: 'scam',
        hint: 'Would any legitimate company pay $300–$500 per day just for liking and sharing posts? What would they need your personal details or payment for after you contact them?',
        explanation: 'This is a job scam — specifically a "like and share" or task-based scam. Victims are initially paid small amounts to build trust, then asked to make larger "investments" to unlock bigger payouts, which are never received. No legitimate employer offers $300–$500/day for liking posts with zero experience or qualifications required.',
        red_flags: [
    ...
    // ── Q7 ── post / satire ──────────────────────────────────────────────────────
    {
        id: 8,
        question_type: 'post',
        content: '😂 NParks announces MRT stations will now be planted with 500 trees each, with birds\' nests provided at every seat. "Green Singapore has entered the tunnel," says spokesperson. 🌳🚇',
        likes: '26.3K',
        shares: '19.1K',
        comments: '7.4K',
        correct_answer: 'satire',
        hint: 'Is this premise physically possible? Is the tone humorous and the scenario deliberately absurd? Satire often takes a real-world trend (like Singapore\'s greenery push) to an extreme.',
        explanation: 'This is satire commenting on Singapore\'s genuine efforts to green its urban infrastructure. The idea of 500 trees per MRT station and birds\' nests on every seat is deliberately impossible. The pun "Green Singapore has entered the tunnel" signals this is parody. Recognising satire prevents you from spreading fictional stories as news.',
        red_flags: [],
        manipulation_tactics: [],
    },
    // ── Q8 ── VIDEO / scam ───────────────────────────────────────────────────────
    ...
    // ── Q9 ── post / real ────────────────────────────────────────────────────────
    {
        id: 10,
        question_type: 'post',
        content: '⚠️ Advisory from MAS: The Monetary Authority of Singapore warns the public about unlicensed cryptocurrency investment platforms promising guaranteed returns. Always check if platforms are licensed at mas.gov.sg/investor-alert-list.',
        likes: '4.1K',
        shares: '7.3K',
        comments: '892',
        correct_answer: 'real',
        hint: 'Does this come from a verifiable government source? Is the advice cautious and actionable, and does it reference an official website you can independently check right now?',
        explanation: 'This is real, official information from the Monetary Authority of Singapore. MAS regularly issues advisories about investment scams. The specific reference to mas.gov.sg/investor-alert-list is a verifiable, real resource you can visit. Notice the tone is advisory — no urgency, no suspicious links, no requests for personal information.',
        red_flags: [],
        manipulation_tactics: [],
    },
];
...
export const MODULE_SLUGS = ['spot-the-spin', 'chain-reaction', 'shield-squad'];
export const XP_CORRECT = 50;
export const XP_WRONG = 40;
export const MODULE_COMPLETION_XP = {
    'spot-the-spin': 200,
    'chain-reaction': 150,
    'shield-squad': 150,
};
