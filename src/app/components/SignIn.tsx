...
export function SignIn() {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      await signInWithGoogle(); // Supabase redirects away — no navigate needed
    } catch (err: unknown) {
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl border border-gray-200 shadow-sm p-8">
            ...
            <button
              ...
              disabled={loading || googleLoading}
              className="w-full flex items-center justify-center gap-2 border border-gray-200 rounded-xl py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all disabled:opacity-70"
            >
              {googleLoading ? (
