...
const SCAN_THEME: Record<
  TelegramRecentScan["color"],
  { panel: string; border: string; accent: string }
> = {
...
const exampleConversation = [
  ...
  },
  {
    type: "user",
    message:
      "🚨 URGENT: Your DBS account has been locked! Click here immediately to unlock: dbs-sg-secure.xyz/unlock",
    timestamp: "10:25 AM",
    forwarded: true,
  },
  {
...
export function TelegramBot() {
  ...
  const [commands, setCommands] =
    useState<TelegramBotCommand[]>(SAMPLE_COMMANDS);
  const [stats, setStats] = useState<TelegramStats>(SAMPLE_STATS);
  const [recentScans, setRecentScans] =
    useState<TelegramRecentScan[]>(SAMPLE_RECENT_SCANS);
  ...
  useEffect(() => {
    ...
    async function loadPageData() {
      try {
        setError(null);
        const publicInfo = await apiFetch<TelegramBotInfo>(
          "/api/integrations/telegram/info",
        );
        const publicCommands = await apiFetch<TelegramBotCommand[]>(
          "/api/integrations/telegram/commands",
        );
        ...
        if (session?.access_token) {
          const [status, userStats, scans] = await Promise.all([
            apiFetch<TelegramLinkStatus>(
              "/api/integrations/telegram/status",
              undefined,
              session.access_token,
            ),
            apiFetch<TelegramStats>(
              "/api/integrations/telegram/stats",
              undefined,
              session.access_token,
            ),
            apiFetch<TelegramRecentScan[]>(
              "/api/integrations/telegram/scans",
              undefined,
              session.access_token,
            ),
          ]);
        ...
        if (!cancelled) {
          setError(
            err instanceof Error ? err.message : "Failed to load Telegram page",
          );
        }
      } finally {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Forward messages to Telegram for instant threat analysis and saved
            XP.
          </p>
        </div>
        <Link
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-5">
            ...
            <h2 className="text-4xl font-black">
              Meet Your Personal Scam Detector
            </h2>
            <p className="text-lg text-blue-100 leading-relaxed">
              Forward suspicious messages, links, or images to{" "}
              {botInfo.username} and get instant AI-powered analysis. When your
              profile is linked, scans and XP are saved automatically.
            </p>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-2xl w-full max-w-sm text-gray-900">
              <div className="text-center mb-4">
                ...
                <p className="text-sm text-gray-600">
                  Scan the QR code to open the bot instantly
                </p>
              </div>
                ...
                {linkCode && (
                  <div className="rounded-2xl border border-purple-200 bg-purple-50 p-4 text-left">
                    ...
                    <p className="text-xs text-gray-600 mt-2">
                      Send <span className="font-mono">/link {linkCode}</span>{" "}
                      in Telegram to connect your profile.
                    </p>
                    {linkExpiresAt && (
              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    title: "Start the Bot",
                    description: session
                      ? "Tap Start, then link your account with the generated code"
                      : "Sign in here first so you can generate a link code",
                  ...
                  },
                  {
                    ...
                    description:
                      "Forward any suspicious message for instant AI analysis and saved XP",
                  ...
                  <div key={step.step} className="relative">
                    ...
                    <div className="flex items-start gap-4">
                      <div
                        className={`w-12 h-12 bg-gradient-to-br ${step.color} rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg relative z-10`}
                      >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">
                      Your scans are tied to your linked profile, so XP and
                      recent history follow you across Telegram sessions.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            className={`text-sm whitespace-pre-wrap ${msg.analysis ? "text-gray-900" : ""}`}
                          >
                            {msg.message}
                          </div>
                        </div>
              ...
              <div className="mt-6 p-4 bg-green-50 border-2 border-green-200 rounded-xl">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-green-800">
                    <strong>Pro Tip:</strong> Forward messages from any chat to
                    get instant analysis. Once linked, your scans are saved to
                    your profile.
                  </div>
                </div>
              </div>
                ...
                <div className="p-5 bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-blue-200 rounded-xl">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700">
                        Get instant analysis of suspicious texts, emails, or
                        social media posts
                      </p>
                    </div>
                  </div>
                ...
                <div className="p-5 bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 rounded-xl">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700">
                        Generate a code on the web page and send{" "}
                        <span className="font-mono">/link CODE</span> in
                        Telegram
                      </p>
                    </div>
                  </div>
                ...
                <div className="p-5 bg-gradient-to-br from-orange-50 to-red-50 border-2 border-orange-200 rounded-xl">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700">
                        Receive step-by-step guidance on what to do next
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700">
                        Get +25 XP for each scan and unlock related training
                        missions
                      </p>
                    </div>
                  </div>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                {recentScans.length === 0 ? (
                  <div className="rounded-xl border border-dashed border-gray-300 bg-gray-50 p-4 text-sm text-gray-600">
                    No Telegram scans yet. Forward a suspicious message after
                  ...
                  recentScans.map((scan) => (
                    <div
                      key={scan.scan_id}
                      className={`p-4 ${SCAN_THEME[scan.color].panel} border-2 ${SCAN_THEME[scan.color].border} rounded-xl hover:shadow-md transition-all`}
                    >
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <div
                          className={`text-2xl font-black ${SCAN_THEME[scan.color].accent}`}
                        >
                          {scan.risk_score}
                        </div>
                      </div>
                      ...
                      >
                        <div
                          className={`w-2 h-2 rounded-full ${scan.risk_score > 70 ? "bg-red-500" : scan.risk_score > 40 ? "bg-yellow-500" : "bg-green-500"} animate-pulse`}
                        />
            ...
            <div className="bg-gradient-to-br from-red-600 to-orange-600 rounded-2xl p-6 text-white shadow-xl">
              ...
              <p className="text-blue-100 text-sm mb-4">
                Start using the Telegram bot today and protect yourself from
                scams instantly.
              </p>
              <a
                href={botInfo.url}
